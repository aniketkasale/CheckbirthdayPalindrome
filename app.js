...
checkBtn.addEventListener("click", function clickHandler(){
        ...
        if(state){
            document.getElementById("result").innerText = "Your BirthDay is Palindrome"+ resultDate;
        }
        else{
             var nearDate = findNextNearPalindromeDate(birthDate.value);
             document.getElementById("result").innerText = "Your Birthday Date is not palindrome . Next palindrome date is "+ nearDate +" which comes after "+noOfDays + "days";
        }
